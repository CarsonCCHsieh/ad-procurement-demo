<?php
/**
 * Template Name: VT Platform Index
...
<head>
	...
	<link rel="canonical" href="<?php echo esc_url( vtportal_url_with_lang( '/platforms/', $current_lang ) ); ?>">
	<meta name="description" content="<?php echo esc_attr( __( '渚濆钩鍙扮€忚 VTuber锛歒ouTube銆乀witch 绛夊钩鍙板垎椤炶垏姊濈洰鏁搞€?', 'vtuber-portal' ) ); ?>">
	<?php wp_head(); ?>
</head>
...
<main class="vt-layout">
	...
	<section class="vt-section">
		<h1><?php esc_html_e( '渚濆钩鍙扮€忚', 'vtuber-portal' ); ?></h1>
		<p class="vt-body-text"><?php esc_html_e( '蹇€熸煡鐪嬪悇骞冲彴姊濈洰鏁革紝榛炴搳鍗冲彲绡╅伕瑭插钩鍙扮殑 VTuber銆?', 'vtuber-portal' ); ?></p>

		<?php if ( empty( $terms ) ) : ?>
			<p class="vt-body-text"><?php esc_html_e( '灏氱劇骞冲彴璩囨枡銆?', 'vtuber-portal' ); ?></p>
		<?php else : ?>
					...
					<article class="vt-card">
						<a class="vt-card-block" href="<?php echo esc_url( get_term_link( $t ) ); ?>">
							<div class="vt-card-body">
								...
								<div class="vt-tax-list"><span class="pill"><?php esc_html_e( '骞冲彴', 'vtuber-portal' ); ?></span></div>
							</div>
						</a>
					</article>
				<?php endforeach; ?>
