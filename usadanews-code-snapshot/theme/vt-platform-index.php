...
<head>
	...
	<meta name="description" content="<?php echo esc_attr( __( '依平台瀏覽 VTuber：YouTube、Twitch 等平台分類與條目數。', 'vtuber-portal' ) ); ?>">
	<?php wp_head(); ?>
</head>
...
<main class="vt-layout">
	...
	<section class="vt-section">
		<h1><?php esc_html_e( '依平台瀏覽', 'vtuber-portal' ); ?></h1>
		<p class="vt-body-text"><?php esc_html_e( '快速查看各平台條目數，點擊即可篩選該平台的 VTuber。', 'vtuber-portal' ); ?></p>

		<?php if ( empty( $terms ) ) : ?>
			<p class="vt-body-text"><?php esc_html_e( '尚無平台資料。', 'vtuber-portal' ); ?></p>
		<?php else : ?>
					...
					<article class="vt-card">
						<a class="vt-card-block" href="<?php echo esc_url( get_term_link( $t ) ); ?>">
							<div class="vt-card-body">
								...
								<div class="vt-tax-list"><span class="pill"><?php esc_html_e( '平台', 'vtuber-portal' ); ?></span></div>
							</div>
						</a>
					</article>
				<?php endforeach; ?>
