<?php
/**
 * Template: Taxonomy Role Tag (standalone)
 */
...
<head>
	...
	<?php if ( ! defined( 'WPSEO_VERSION' ) ) : ?>
		<meta name="description" content="<?php echo esc_attr( sprintf( __( '渚濆収瀹规绫ゆ暣鐞嗘鐩細%s銆?', 'vtuber-portal' ), (string) $term->name ) ); ?>">
	<?php endif; ?>
...
<main class="vt-layout">
	...
	<section class="vt-section">
		...
		<p class="vt-body-text"><?php esc_html_e( '渚濆収瀹规绫ゅ綑鏁寸殑姊濈洰娓呭柈銆?', 'vtuber-portal' ); ?></p>
		<div class="vt-body-text" style="display:flex;gap:10px;flex-wrap:wrap;align-items:center;margin:10px 0 16px;">
			...
			<a class="vt-pill" href="<?php echo esc_url( vtportal_url_with_lang( '/roles/', $current_lang ) ); ?>"><?php esc_html_e( '全部風格標籤', 'vtuber-portal' ); ?></a>
					...
					<article class="vt-card">
						...
						<div class="vt-card-body">
							...
							<div class="vt-tax-list">
								...
								$shown = 0;
								foreach ( [ $roles, $agencies, $platforms ] as $list ) {
									if ( empty( $list ) ) {
										continue;
									}
									foreach ( $list as $t ) {
