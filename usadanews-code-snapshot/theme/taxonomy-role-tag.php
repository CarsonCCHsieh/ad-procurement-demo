...
<head>
	...
	<?php if ( ! defined( 'WPSEO_VERSION' ) ) : ?>
		<meta name="description" content="<?php echo esc_attr( sprintf( __( '依內容標籤整理條目：%s。', 'vtuber-portal' ), (string) $term->name ) ); ?>">
	<?php endif; ?>
...
<main class="vt-layout">
	...
	<section class="vt-section">
		...
		<p class="vt-body-text"><?php esc_html_e( '依內容標籤彙整的條目清單。', 'vtuber-portal' ); ?></p>
