...
<head>
	...
	<meta name="description" content="<?php echo esc_attr( __( '依出道年份瀏覽 VTuber：快速查看各年份條目數並進入清單。', 'vtuber-portal' ) ); ?>">
	<?php wp_head(); ?>
</head>
...
<main class="vt-layout">
	...
	<section class="vt-section">
		<h1><?php esc_html_e( '依出道年份瀏覽', 'vtuber-portal' ); ?></h1>
		<p class="vt-body-text"><?php esc_html_e( '依出道年份彙整 VTuber 條目，點擊即可篩選。', 'vtuber-portal' ); ?></p>

		<?php if ( empty( $terms ) ) : ?>
			<p class="vt-body-text"><?php esc_html_e( '尚無出道年份資料。', 'vtuber-portal' ); ?></p>
		<?php else : ?>
					...
					<article class="vt-card">
						<a class="vt-card-block" href="<?php echo esc_url( get_term_link( $t ) ); ?>">
							<div class="vt-card-body">
								...
								<div class="vt-tax-list"><span class="pill"><?php esc_html_e( '出道年份', 'vtuber-portal' ); ?></span></div>
							</div>
						</a>
					</article>
				<?php endforeach; ?>
