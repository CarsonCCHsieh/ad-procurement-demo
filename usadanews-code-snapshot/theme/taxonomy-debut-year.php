...
<head>
	...
	<?php if ( ! defined( 'WPSEO_VERSION' ) ) : ?>
		<meta name="description" content="<?php echo esc_attr( sprintf( __( '渚濆嚭閬撳勾浠芥暣鐞?VTuber 姊濈洰锛?s銆?', 'vtuber-portal' ), (string) $term->name ) ); ?>">
	<?php endif; ?>
...
<main class="vt-layout">
	...
	<section class="vt-section">
		...
		<?php else : ?>
			<p class="vt-body-text"><?php esc_html_e( '渚濆嚭閬撳勾浠藉綑鏁寸殑 VTuber 娓呭柈銆?', 'vtuber-portal' ); ?></p>
		<?php endif; ?>
